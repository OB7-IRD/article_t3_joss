...
\hline
C6 & Software code languages, tools, and services used & r \footnote{Mettre CSV, postgresSQL , ms access ?}\\
\hline
C7 & Compilation requirements, operating environments \& dependencies & A REMPLIR\\
\hline
C8 & If available Link to developer documentation/manual & For example: $http://ob7-ird.github.io/t3/$ \\
\hline
