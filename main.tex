...
%% \address[label1]{}
%% \address[label2]{}
\author[ob7,marbec]{Mathieu Depetris}
...
\hline
C2 & Permanent link to code/repository used for this code version &$https://github.com/OB7-IRD/t3$ \\
\hline
...
\hline
C8 & If available Link to developer documentation/manual & $http://ob7-ird.github.io/t3/$ \\
\hline
